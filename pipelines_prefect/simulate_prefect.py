...
def GenerateData():
    ...
    return [dict_ds, dict_heat_consumption, dict_heat_supply, dict_elec_supply, dict_elec_consumption, dict_weather]
...
@task
def simulate_data():
    dict_ds, dict_heat_consumption, dict_heat_supply, dict_elec_supply, dict_elec_consumption, dict_weather = GenerateData()
    return dict_ds, dict_heat_consumption, dict_heat_supply, dict_elec_supply, dict_elec_consumption, dict_weather

@task
def send_data(measurement_name, dict_, dict_ds):
    SendData2Influx(measurement_name, dict_, dict_ds)

@flow
def sim_and_send():
    dict_ds, dict_heat_consumption, dict_heat_supply, dict_elec_supply, dict_elec_consumption, dict_weather = simulate_data()
    send_data("heat_supply", dict_heat_supply, dict_ds)
    send_data("heat_consumption", dict_heat_consumption, dict_ds)
    send_data("electricity_supply", dict_elec_supply, dict_ds)
    send_data("electricty_consumption", dict_elec_consumption, dict_ds)
    send_data("weather_info", dict_weather, dict_ds)
